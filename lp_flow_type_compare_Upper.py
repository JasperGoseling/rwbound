...
# The type plus is eactly half of the type set. We divide the directions in the type set into two subsets. One is type_plus and the other one is type_minus.
...
# If, for example (1,-1) and (-1,1) are in the type set, we put any one of them in set type_plus.
